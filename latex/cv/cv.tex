...
\raisebox{\dimexpr-\height+\ht\strutbox}{\includegraphics[height=0.7\textwidth, width=0.7\textwidth]{profile.png}}
...
{Pandora, CPH, Denmark}
{
	...
	\begin{itemize}[itemsep=0pt]
		...
		%\item Initiate mutual collaboration and best practices																	 for data scientists and the MLOps team.
	\end{itemize}
}
\job
{Oct 2018 }{Sep 2021}
