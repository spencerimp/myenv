...
%\raisebox{\dimexpr-\height+\ht\strutbox}{\includegraphics[width=\textwidth]{profile.png}}
%\raisebox{\dimexpr-0.5\height+\ht\strutbox}{\includegraphics[width=\textwidth]{profile.png}}
\raisebox{\dimexpr-\height+\ht\strutbox}{\includegraphics[height=\textwidth]{profile.png}}
%\begin{tabbing} % Enables tabbing
%\hspace{3cm} \= \hspace{4cm} \= \kill % Spacing within the block
%{\small spencer.tengz@gmail.com} \\ % Email address
%{\small linkedin.com/in/spencerimp/} \\ % LinkedIn
%\end{tabbing}
